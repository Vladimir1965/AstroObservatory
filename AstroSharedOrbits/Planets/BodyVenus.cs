...
namespace AstroSharedOrbits.Planets {
    ...
    public sealed class BodyVenus : Orbit {
        ...
        public static double EclipticLongitude(double julianDay) {
            ...
            double l0 = 0;
            int i;
            for (i = 0; i < OrbitalData.VsopData.L0VenusCoefficients.Length; i++) {
                l0 += OrbitalData.VsopData.L0VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.L0VenusCoefficients[i].B + OrbitalData.VsopData.L0VenusCoefficients[i].C * rho);
            }

            //// Calculate L1
            double l1 = 0;
            for (i = 0; i < OrbitalData.VsopData.L1VenusCoefficients.Length; i++) {
                l1 += OrbitalData.VsopData.L1VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.L1VenusCoefficients[i].B + OrbitalData.VsopData.L1VenusCoefficients[i].C * rho);
            }

            //// Calculate L2
            double l2 = 0;
            for (i = 0; i < OrbitalData.VsopData.L2VenusCoefficients.Length; i++) {
                l2 += OrbitalData.VsopData.L2VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.L2VenusCoefficients[i].B + OrbitalData.VsopData.L2VenusCoefficients[i].C * rho);
            }

            //// Calculate L3
            double l3 = 0;
            for (i = 0; i < OrbitalData.VsopData.L3VenusCoefficients.Length; i++) {
                l3 += OrbitalData.VsopData.L3VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.L3VenusCoefficients[i].B + OrbitalData.VsopData.L3VenusCoefficients[i].C * rho);
            }

            //// Calculate L4
            double l4 = 0;
            for (i = 0; i < OrbitalData.VsopData.L4VenusCoefficients.Length; i++) {
                l4 += OrbitalData.VsopData.L4VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.L4VenusCoefficients[i].B + OrbitalData.VsopData.L4VenusCoefficients[i].C * rho);
            }

            //// Calculate L5
            double l5 = 0;
            for (i = 0; i < OrbitalData.VsopData.L5VenusCoefficients.Length; i++) {
                l5 += OrbitalData.VsopData.L5VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.L5VenusCoefficients[i].B + OrbitalData.VsopData.L5VenusCoefficients[i].C * rho);
            }
        ...
        public static double EclipticLatitude(double julianDay) {
            ...
            double b0 = 0;
            int i;
            for (i = 0; i < OrbitalData.VsopData.B0VenusCoefficients.Length; i++) {
                b0 += OrbitalData.VsopData.B0VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.B0VenusCoefficients[i].B + OrbitalData.VsopData.B0VenusCoefficients[i].C * rho);
            }

            //// Calculate B1
            double b1 = 0;
            for (i = 0; i < OrbitalData.VsopData.B1VenusCoefficients.Length; i++) {
                b1 += OrbitalData.VsopData.B1VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.B1VenusCoefficients[i].B + OrbitalData.VsopData.B1VenusCoefficients[i].C * rho);
            }

            //// Calculate B2
            double b2 = 0;
            for (i = 0; i < OrbitalData.VsopData.B2VenusCoefficients.Length; i++) {
                b2 += OrbitalData.VsopData.B2VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.B2VenusCoefficients[i].B + OrbitalData.VsopData.B2VenusCoefficients[i].C * rho);
            }

            //// Calculate B3
            double b3 = 0;
            for (i = 0; i < OrbitalData.VsopData.B3VenusCoefficients.Length; i++) {
                b3 += OrbitalData.VsopData.B3VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.B3VenusCoefficients[i].B + OrbitalData.VsopData.B3VenusCoefficients[i].C * rho);
            }

            //// Calculate B4
            double b4 = 0;
            for (i = 0; i < OrbitalData.VsopData.B4VenusCoefficients.Length; i++) {
                b4 += OrbitalData.VsopData.B4VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.B4VenusCoefficients[i].B + OrbitalData.VsopData.B4VenusCoefficients[i].C * rho);
            }
        ...
        public static double RadiusVector(double julianDay) {
            ...
            double r0 = 0;
            int i;
            for (i = 0; i < OrbitalData.VsopData.R0VenusCoefficients.Length; i++) {
                r0 += OrbitalData.VsopData.R0VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.R0VenusCoefficients[i].B + OrbitalData.VsopData.R0VenusCoefficients[i].C * rho);
            }

            //// Calculate R1
            double r1 = 0;
            for (i = 0; i < OrbitalData.VsopData.R1VenusCoefficients.Length; i++) {
                r1 += OrbitalData.VsopData.R1VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.R1VenusCoefficients[i].B + OrbitalData.VsopData.R1VenusCoefficients[i].C * rho);
            }

            //// Calculate R2
            double r2 = 0;
            for (i = 0; i < OrbitalData.VsopData.R2VenusCoefficients.Length; i++) {
                r2 += OrbitalData.VsopData.R2VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.R2VenusCoefficients[i].B + OrbitalData.VsopData.R2VenusCoefficients[i].C * rho);
            }

            //// Calculate R3
            double r3 = 0;
            for (i = 0; i < OrbitalData.VsopData.R3VenusCoefficients.Length; i++) {
                r3 += OrbitalData.VsopData.R3VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.R3VenusCoefficients[i].B + OrbitalData.VsopData.R3VenusCoefficients[i].C * rho);
            }

            //// Calculate R4
            double r4 = 0;
            for (i = 0; i < OrbitalData.VsopData.R4VenusCoefficients.Length; i++) {
                r4 += OrbitalData.VsopData.R4VenusCoefficients[i].A * Math.Cos(OrbitalData.VsopData.R4VenusCoefficients[i].B + OrbitalData.VsopData.R4VenusCoefficients[i].C * rho);
            }
