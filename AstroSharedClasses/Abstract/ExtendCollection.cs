...
namespace AstroSharedClasses.Abstract
{
    ...
    public static class ExtendCollection<T> where T : new() {
        ...
        public static T GetRandomObject(Collection<T> collection) {
            ...
            var mpos = MathSupport.RandomNatural(collection.Count - 1);
            return mpos < 0 ? default(T) : collection.ElementAtOrDefault(mpos);
        }
        ...
        public static T GetRandomObject(IEnumerable<T> enumerable) {
            ...
            var mpos = MathSupport.RandomNatural(enumerable1.Count - 1);
            return mpos < 0 ? default(T) : enumerable1.ElementAtOrDefault(mpos);
        }
